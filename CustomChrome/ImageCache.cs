...
namespace CustomChrome
{
    internal class ImageCache : IDisposable
    {
        ...
        public Bitmap Minimize { get; private set; }
        public Bitmap Maximize { get; private set; }
        public Bitmap Restore { get; private set; }
        public Bitmap Close { get; private set; }
        ...
        public ImageCache(Color baseColor)
        {
            ...
            Minimize = Build(ImageMaps.Minimize, 0);
            Maximize = Build(ImageMaps.Maximize, 0);
            Restore = Build(ImageMaps.Restore, 0);
            Close = Build(ImageMaps.Close, 0);
        }
